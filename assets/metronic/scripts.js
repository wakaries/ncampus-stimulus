// Keenthemes' plugins
window.KTComponents = require('./js/components/_init.js');
...
// Layout base js
window.KTAppSidebar = require('./js/layout/sidebar.js');
window.KTLayoutSearch = require('./js/layout/search.js');
window.KTLayoutToolbar = require('./js/layout/toolbar.js');
window.KTThemeMode = require('./js/layout/theme-mode.js');
window.KTThemeModeUser = require('./js/layout/theme-mode-user.js');
